// Playwright REPL driver for FAC Shack Dashboard (Electron)
...
const COMMANDS = {
  async launch() {
    ...
    console.log('launching from:', APP_DIR);
...
console.log('FAC Shack Dashboard driver — "help" for commands, "launch" to start');
rl.prompt();
